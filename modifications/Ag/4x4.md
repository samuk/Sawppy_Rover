...
- [LeoRover](https://www.leorover.tech/guides/ros-development) ROS1
- [Ubiquity](https://github.com/UbiquityRobotics) ROS1

Our offer 

2WD/ 4WD IP54/5 platform ready for [GUI programming](https://github.com/FlexBE/flexible_navigation) 
